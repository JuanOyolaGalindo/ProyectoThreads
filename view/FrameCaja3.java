...
public class FrameCaja3 extends JFrame{
	...
	public JLayeredPane ponerComponentes(ActionListener listener) {
		...
		atrasbut.setActionCommand("atras2");
		sigbut.addActionListener(listener);
		sigbut.setActionCommand("sigto1");
	...
	public JButton getAtrasbut() {
		return atrasbut;
	}



	public void setAtrasbut(JButton atrasbut) {
		this.atrasbut = atrasbut;
	}



	public JButton getSigbut() {
		return sigbut;
	}



	public void setSigbut(JButton sigbut) {
		this.sigbut = sigbut;
	}



	public JButton[][] getPokemones() {
		return pokemones;
	}



	public void setPokemones(JButton[][] pokemones) {
		this.pokemones = pokemones;
	}



	public JButton getSalirbut() {
		return salirbut;
	}



	public void setSalirbut(JButton salirbut) {
		this.salirbut = salirbut;
	}
