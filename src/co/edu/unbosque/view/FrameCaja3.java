...
public class FrameCaja3 extends JFrame{
	...
	/**
	 * Metodo constructor FrameCaja3. Establece el tamaño de la ventana, crea una
 * matriz JButton bidimensional para contener el Pokémon, crea un diseño nulo, centra la ventana,
 * establece el panel de fondo en una imagen de fondo y agrega componentes GUI.
	...
	/**
	 * 
	 * @param listener ActionListener que se añade a cada boton para los ActionListener
