...
import javax.swing.*;
/**
 * representa el panel principal del juego en donde se muestra la caja 2 del entrenador y los pokemon que contiene
 * @author Grupo
 * @version finalversion sin modelo
 */
public class FrameCaja2 extends JFrame{
	...
	/**
	 * Crea el panel que contiene el nombre del pokemon
	 * @return  un objeto jPanel que contiene el nombre del pokemon
	 */
	...
	/**
	 * Crea el panel principal que muestra la caja 2 del entranador y los pokemon que contiene
	 * @param listener el objeto ActionListener que maneja los eventos de los botones
	 * @return un objeto JLayeredPane que contiene los componentes de la caja 2
	 */
	...
	/**
	 * Crea el menu de pokemones con imagenes aleatorias de pokemon
	 * @param listener ActionListener que se asigna a cada boton del menu de pokemones
	 * @return JPanel que contiene el menu de pokemones
	 */
	...
	/**
	 * Crea el menu de movimientos con los detalles de los pokemon seleccionados
	 * @return JPanel que contiene el menu de movimientos
	 */
