...
public class FramePrincipal extends JFrame{
	...
	/**
	 * 
	 * @param listener ActionListener utilizado para manejar los eventos de los botones
	 */
	...
	/**
	 * Metodo que crea y devuelve el pane1 que contiene el nombre del pokemon seleccionado
	 * @return JPanel que contiene el nombre del pokemon seleccionado
	 */
	...
	/**
	 * Metodo que crea y devuelve el panelCaja que contiene los componentes de la ventana
	 * @param listener ActionListener utilizado para manejar los eventos de los botones
	 * @return JLayeredPane que contioene los componentes de la ventana
	 */
	...
	/**
	 * Metodo que crea y retorna un papel con un panel con una matriz de botones con imagenes de Pokemones aleatorios
	 * @param listener el objeto que implementa la interfaz ActionListener y sera asignado a los botones
	 * @return un JPanel con la matriz de botones de Pokemones
	 */
	...
	/**
	 * Metodo que crea y retorna un panel con JLabels que representan el tipo, nivel, objeto y movimiento de un Pokemon
	 * @return un JPanel con los JLabels correspondientes
	 */
